...
define([
  ...
  var ConnectionView = Backbone.View.extend({
    ...
    rowPhysicalInventory_tap: function () {
      ...
      this.SwitchDisplay(2);
      this.ShowFeaturePreferenceSection(
        Enum.ListMode.PhysicalInventoryPreference
      );
      this.InitializeFeaturePreference();
    },
    ...
    rowlocal_tap: function () {
      this.HighLightSelectedRow("rowlocal", false);
      this.SwitchDisplay(2);
      this.ShowFeaturePreferenceSection(Enum.ListMode.LocalSetting);

      // this.InitializeFeaturePreference();

      //this.HighLightSelectedRow('rowlocal', false);
      //this.ShowLocalSettingSection("Local Setting");
      // $('#localSetting').show();
      //this.LoadPreferenceLookup();
    },
    ...
    rowWebSite_tap: function () {
      ...
      this.ShowCheckListSection(
        Enum.ListMode.ItemImagesPreference,
        "web sites"
      );
    ...
    AssignCurrentPreference: function (preference) {
      ...
      CurrentPreference.AdjustmentIsPromptForQty =
        preference.AdjustmentIsPromptForQty;
      CurrentPreference.AdjustmentIsShowQtyOnHand =
        preference.AdjustmentIsShowQtyOnHand;
      CurrentPreference.LabelSourceTransaction =
        preference.LabelSourceTransaction;
      ...
      CurrentPreference.PackSourceTransaction =
        preference.PackSourceTransaction;
      CurrentPreference.PhysicalInventoryIsAllowToSkipItems =
        preference.PhysicalInventoryIsAllowToSkipItems;
      CurrentPreference.PhysicalInventoryIsPromptForQty =
        preference.PhysicalInventoryIsPromptForQty;
      CurrentPreference.PhysicalInventoryIsShowQtyOnHand =
        preference.PhysicalInventoryIsShowQtyOnHand;
      CurrentPreference.PhysicalInventoryIsAutoPost =
        preference.PhysicalInventoryIsAutoPost;
      CurrentPreference.PickIsAllowToSkipItems =
        preference.PickIsAllowToSkipItems;
      CurrentPreference.PickIsPromptBinManager =
        preference.PickIsPromptBinManager;
      ...
      CurrentPreference.PickSourceTransaction =
        preference.PickSourceTransaction;
      ...
      CurrentPreference.PreventDuplicateSerialNumber =
        preference.PreventDuplicateSerialNumber;
      CurrentPreference.SupplierPreventDuplicateSerialNumber =
        preference.SupplierPreventDuplicateSerialNumber;
      CurrentPreference.ReceiveIsPromptBinManager =
        preference.ReceiveIsPromptBinManager;
      CurrentPreference.ReceiveIsPromptForQty =
        preference.ReceiveIsPromptForQty;
      CurrentPreference.ReceiveIsShowQtyOnHand =
        preference.ReceiveIsShowQtyOnHand;
      CurrentPreference.SerialNumberTransactionValidationType =
        preference.SerialNumberTransactionValidationType;
      CurrentPreference.SupplierSerialNumberTransactionValidationType =
        preference.SupplierSerialNumberTransactionValidationType;
      CurrentPreference.StockIsPromptBinManager =
        preference.StockIsPromptBinManager;
      ...
      CurrentPreference.TransferIsPromptForQty =
        preference.TransferIsPromptForQty;
      CurrentPreference.TransferIsShowQtyOnHand =
        preference.TransferIsShowQtyOnHand;
      ...
      CurrentPreference.EnableAdvancedFreightRateCalculation =
        preference.EnableAdvancedFreightRateCalculation;
    },
    ...
    CreatePreference: function () {
      ...
      if (workstationID != null && workstationID != "") {
        ...
        settingsModel.url =
          Global.ServiceUrl + Service.POS + Method.UPDATEWAREHOUSEPREFERENCE;
            ...
            if (!model.get("hasError")) {
              ...
              if (self.cartItems && self.cartItems.models.length > 0) {
                self.cartItems.each(function (item) {
                  if (
                    item.get("ListItemLabel") ==
                    response.Preference.WorkstationID
                  ) {
              ...
              if (!isWorkstationExist) {
                ...
                model.set({
                  ...
                  ListItemLabel2:
                    "Location: " + response.Preference.DefaultLocation,
                  ListMode: listMode,
                });
                self.RenderListItem(listMode, model);
                self.checkListiScroll = Shared.LoadiScroll(
                  self.checkListiScroll,
                  "CheckList"
                );
              }
            }
          ...
          if (button == 1) {
            if (selectedItem != null) {
              ...
              settingsModel.url =
                Global.ServiceUrl +
                Service.POS +
                Method.DELETEWAREHOUSEPREFERENCE;
    ...
    HideDescription: function (featureName) {
      ...
      this.featurePreferenceiScroll = Shared.LoadiScroll(
        this.featurePreferenceiScroll,
        "FeaturePreference"
      );
    },
          ...
          if (!model.get("hasError")) {
            if (self.preferences.length == 0) {
              ...
              self.preferences.create({
                DefaultWorkstation: Global.WorkstationID,
              });
            } else {
              self.SetDefaultWorkstationID(
                self.preferences.models[0].get("DefaultWorkstation")
              );
            }
          }
        },
    ...
    InitializeModel: function () {
      ...
      this.model.set({
        ...
        PhysicalInventoryIsAllowToSkipItems:
          CurrentPreference.PhysicalInventoryIsAllowToSkipItems,
        PhysicalInventoryIsPromptForQty:
          CurrentPreference.PhysicalInventoryIsPromptForQty,
        PhysicalInventoryIsShowQtyOnHand:
          CurrentPreference.PhysicalInventoryIsShowQtyOnHand,
        PhysicalInventoryIsAutoPost:
          CurrentPreference.PhysicalInventoryIsAutoPost,
        ...
        PreventDuplicateSerialNumber:
          CurrentPreference.PreventDuplicateSerialNumber,
        SupplierPreventDuplicateSerialNumber:
          CurrentPreference.SupplierPreventDuplicateSerialNumber,
        ...
        SerialNumberTransactionValidationType:
          CurrentPreference.SerialNumberTransactionValidationType,
        SupplierSerialNumberTransactionValidationType:
          CurrentPreference.SupplierSerialNumberTransactionValidationType,
        ...
        WebSite: CurrentPreference.UseCbeImage
          ? CurrentPreference.WebSiteDescription
          : "Default Image",
        EnableAdvancedFreightRateCalculation:
          CurrentPreference.EnableAdvancedFreightRateCalculation,
      });
    ...
    InitializeFeaturePreference: function () {
      switch (this.model.get("ListMode")) {
        case Enum.ListMode.AdjustmentPreference:
          $("#switchIsPromptForQty").bootstrapSwitch(
            "setState",
            CurrentPreference.AdjustmentIsPromptForQty
          );
          $("#switchIsShowQtyOnHand").bootstrapSwitch(
            "setState",
            CurrentPreference.AdjustmentIsShowQtyOnHand
          );
          $("#switchIsAutoPost").bootstrapSwitch(
            "setState",
            CurrentPreference.AdjustmentIsAutoPost
          );
          break;
        case Enum.ListMode.PackPreference:
          $("#switchIsAutoPrint").bootstrapSwitch(
            "setState",
            CurrentPreference.PackIsAutoPrint
          );
          $("#switchIsPromptForQty").bootstrapSwitch(
            "setState",
            CurrentPreference.PackIsPromptForQty
          );
          $("#switchIsShowQtyOnHand").bootstrapSwitch(
            "setState",
            CurrentPreference.PackIsShowQtyOnHand
          );
          $("#switchIsQuickPack").bootstrapSwitch(
            "setState",
            CurrentPreference.IsQuickPack
          );
          this.SetFeatureSourceTransaction(
            CurrentPreference.PackSourceTransaction
          );
        ...
        case Enum.ListMode.PhysicalInventoryPreference:
          $("#switchIsAllowToSkipItems").bootstrapSwitch(
            "setState",
            CurrentPreference.PhysicalInventoryIsAllowToSkipItems
          );
        ...
        case Enum.ListMode.PickPreference:
          if (localStorage.AllowToScan == "true") {
            $("#switchIsAllowToScanitem").bootstrapSwitch("setState", true);
          } else {
          ...
          $("#switchIsPromptBinManager").bootstrapSwitch(
            "setState",
            CurrentPreference.PickIsPromptBinManager
          );
          $("#switchIsPromptForQty").bootstrapSwitch(
            "setState",
            CurrentPreference.PickIsPromptForQty
          );
          $("#switchIsShowQtyOnHand").bootstrapSwitch(
            "setState",
            CurrentPreference.PickIsShowQtyOnHand
          );
          $("#switchIsBatchPick").bootstrapSwitch(
            "setState",
            CurrentPreference.IsBatchPick
          );
          this.SetFeatureSourceTransaction(
            CurrentPreference.PickSourceTransaction
          );
          $("#switchIsBatchPick").bootstrapSwitch("setActive", false);
          $("#switchIsAutoComplete").bootstrapSwitch(
            "setState",
            CurrentPreference.PickIsAutoComplete
          );
          $("#rowBatchPick").hide();
          break;
        case Enum.ListMode.PrePackPreference:
          $("#switchIsAutoPrint").bootstrapSwitch(
            "setState",
            CurrentPreference.PrePackIsAutoPrint
          );
          $("#switchIsEnable").bootstrapSwitch(
            "setState",
            CurrentPreference.PrePackIsEnable
          );
          break;
        ...
        case Enum.ListMode.StockPreference:
          ...
          $("#switchIsPromptForQty").bootstrapSwitch(
            "setState",
            CurrentPreference.StockIsPromptForQty
          );
          $("#switchIsShowQtyOnHand").bootstrapSwitch(
            "setState",
            CurrentPreference.StockIsShowQtyOnHand
          );
          break;
        case Enum.ListMode.TransferPreference:
          ...
          $("#switchIsAutoPost").bootstrapSwitch(
            "setState",
            CurrentPreference.TransferIsAutoPost
          );
          break;
        case Enum.ListMode.ItemImagesPreference:
          $("#switchUseCbeImage").bootstrapSwitch(
            "setState",
            CurrentPreference.UseCbeImage
          );
          break;
    ...
    LoadPreferenceByWorkstation: function (isLogin) {
      ...
      settingsModel.url =
        Global.ServiceUrl +
        Service.POS +
        Method.GETWAREHOUSEPREFERENCEBYWORKSTATION +
        workstationID;
      self = this;
      settingsModel.fetch({
    ...
    LoadPreferenceLookup: function () {
      var settingsModel = new SettingsModel();
      settingsModel.url =
        Global.ServiceUrl + Service.POS + Method.LOADWAREHOUSEPREFERENCELOOKUP;
      settingsModel.set({ Criteria: null });
      self = this;
      settingsModel.save(null, {
        success: function (model, response, options) {
    ...
    RemoveFromCheckList: function (selectedWorkstationID) {
      if (selectedWorkstationID != null) {
        $("#checkListRow" + selectedWorkstationID.model.get("ViewID"))
          .parent()
          .remove();
        selectedItem = null;
        this.checkListiScroll = Shared.LoadiScroll(
          self.checkListiScroll,
          "CheckList"
        );
      }
    ...
    RenderListItem: function (listMode, item) {
      ...
      switch (listMode) {
        ...
        case Enum.ListMode.DefaultLocations:
          if (
            CurrentPreference.DefaultLocation == item.get("DefaultLocation")
          ) {
            this.HighLightItem(checkListItemView);
    ...
    UpdateFeaturePrefenceNavTitle: function (listMode) {
      switch (listMode) {
        ...
        case Enum.ListMode.ItemImagesPreference:
          ...
          break;
        case Enum.ListMode.LocalSetting:
          $("#featurePreferenceNavTitle").text("stored locally");
          break;
      }
    ...
    HighLightItem: function (itemView) {
      ...
      this.$("#listItem" + itemView.model.get("ViewID"))
        .removeClass("listitem-1")
        .addClass("listitem-2");
    ...
    SetDefaultLocation: function (listItemView) {
      if (
        this.HasChanges(
          CurrentPreference.DefaultLocation,
          listItemView.model.get("DefaultLocation")
        )
      ) {
        CurrentPreference.DefaultLocation =
          listItemView.model.get("DefaultLocation");
        CurrentPreference.WarehouseDescription =
          listItemView.model.get("ListItemLabel");
      }
      this.$("#textDefaultLocation").text(
        CurrentPreference.WarehouseDescription
      );
    },
    ...
    SetDefaultPreference: function (listItemView) {
      if (
        this.HasChanges(
          CurrentPreference.WorkstationID,
          listItemView.model.get("Preference").WorkstationID
        )
      ) {
    ...
    SetWebSite: function (listItemView) {
      if (listItemView != null) {
        if (
          this.HasChanges(
            CurrentPreference.WebSiteCode,
            listItemView.model.get("WebSiteCode")
          )
        ) {
          CurrentPreference.WebSiteCode = listItemView.model.get("WebSiteCode");
          CurrentPreference.WebSiteDescription =
            listItemView.model.get("WebSiteDescription");
    ...
    SaveDefaultWorkstationID: function () {
      if (this.preferences.length > 0) {
        this.preferences.models[0].save({
          DefaultWorkstation: CurrentPreference.WorkstationID,
        });
      }
    },
    ...
    ShowLocalSettingSection: function (title) {},

    ShowCheckListSection: function (mode, title) {
      $("#checkListSection")
        .removeClass("section-close")
      ...
      switch (mode) {
        case Enum.ListMode.Workstations:
          ...
          $("#containerTableCheckList")
            .removeClass("iscroll-cartitem")
            .removeClass("iscroll-lookup")
            .addClass("iscroll-workstation");
          break;
        case Enum.ListMode.DefaultLocations:
        case Enum.ListMode.ItemImagesPreference:
    ...
    UpdateFeaturePreference: function () {
      var newIsAllowToSkipItems = $(
        "#switchIsAllowToSkipItems"
      ...
      var newIsPromptBinManager = $(
        "#switchIsPromptBinManager"
      ).bootstrapSwitch("status");
      var newIsPromptForQty = $("#switchIsPromptForQty").bootstrapSwitch(
        "status"
      );
      var newIsShowQtyOnHand = $("#switchIsShowQtyOnHand").bootstrapSwitch(
        "status"
      );
      ...
      switch (this.model.get("ListMode")) {
        ...
        case Enum.ListMode.PackPreference:
          var newIsQuickPack =
            $("#switchIsQuickPack").bootstrapSwitch("status");

          if (
            this.HasChanges(CurrentPreference.PackIsAutoPrint, newIsAutoPrint)
          ) {
        ...
        case Enum.ListMode.PickPreference:
          var newIsBatchPick =
            $("#switchIsBatchPick").bootstrapSwitch("status");
          var newIsAutoComplete = $("#switchIsAutoComplete").bootstrapSwitch(
            "status"
          );

          localStorage.AllowToScan = $(
            "#switchIsAllowToScanitem"
          ).bootstrapSwitch("status");
          // added by sandeep - support@dynenttech.com related to git #54
          localStorage.AllowForMoreQty = $(
            "#switchIsAllowForMoreQty"
          ).bootstrapSwitch("status");
        ...
        case Enum.ListMode.TransferPreference:
          ...
          if (
            this.HasChanges(CurrentPreference.TransferIsAutoPost, newIsAutoPost)
          ) {
    ...
    WireEvents: function () {
      var self = this;
      Shared.AddRemoveHandler("#buttonCreatePreference", "tap", function (e) {
        self.buttonCreatePreference_tap(e);
      });
      Shared.AddRemoveHandler("#buttonMenu", "tap", function (e) {
        self.buttonMenu_tap(e);
      });
      Shared.AddRemoveHandler("#buttonBackCheckList", "tap", function (e) {
        self.buttonBackCheckList_tap(e);
      });
      Shared.AddRemoveHandler(
        "#buttonBackFeaturePreference",
        "tap",
        function (e) {
          self.buttonBackFeaturePreference_tap(e);
        }
      );
      Shared.AddRemoveHandler(
        "#buttonDeleteWorkstationID",
        "tap",
        function (e) {
          self.buttonDeletePreference_tap(e);
        }
      );
      Shared.AddRemoveHandler("#buttonOrder", "tap", function (e) {
        self.buttonOrder_tap(e);
      });
      Shared.AddRemoveHandler("#buttonInvoice", "tap", function (e) {
        self.buttonInvoice_tap(e);
      });
      Shared.AddRemoveHandler("#rowWorkstationId", "tap", function (e) {
        self.rowWorkstationId_tap(e);
      });
      Shared.AddRemoveHandler("#rowDefaultLocation", "tap", function (e) {
        self.rowDefaultLocation_tap(e);
      });
      Shared.AddRemoveHandler("#rowAdjustment", "tap", function (e) {
        self.rowAdjustment_tap(e);
      });
      Shared.AddRemoveHandler("#rowLabel", "tap", function (e) {
        self.rowLabel_tap(e);
      });
      Shared.AddRemoveHandler("#rowPack", "tap", function (e) {
        self.rowPack_tap(e);
      });
      Shared.AddRemoveHandler("#rowPhysicalInventory", "tap", function (e) {
        self.rowPhysicalInventory_tap(e);
      });
      Shared.AddRemoveHandler("#rowPick", "tap", function (e) {
        self.rowPick_tap(e);
      });
      Shared.AddRemoveHandler("#rowPrePack", "tap", function (e) {
        self.rowPrePack_tap(e);
      });
      Shared.AddRemoveHandler("#rowReceive", "tap", function (e) {
        self.rowReceive_tap(e);
      });
      Shared.AddRemoveHandler("#rowStock", "tap", function (e) {
        self.rowStock_tap(e);
      });
      Shared.AddRemoveHandler("#rowTransfer", "tap", function (e) {
        self.rowTransfer_tap(e);
      });
      Shared.AddRemoveHandler("#rowItemImage", "tap", function (e) {
        self.rowItemImage_tap(e);
      });

      Shared.AddRemoveHandler("#rowWebSite", "tap", function (e) {
        self.rowWebSite_tap(e);
      });
      //Description
      Shared.AddRemoveHandler(
        "#descriptionAllowSkipItems",
        "tap",
        function (e) {
          self.HideDescription("AllowSkipItems");
        }
      );

      Shared.AddRemoveHandler("#descriptionAutoComplete", "tap", function (e) {
        self.HideDescription("AutoComplete");
      });
      Shared.AddRemoveHandler("#descriptionAutoPrint", "tap", function (e) {
        self.HideDescription("AutoPrint");
      });
      Shared.AddRemoveHandler("#descriptionBatchPick", "tap", function (e) {
        self.HideDescription("BatchPick");
      });
      Shared.AddRemoveHandler("#descriptionEnable", "tap", function (e) {
        self.HideDescription("Enable");
      });
      Shared.AddRemoveHandler(
        "#descriptionPromptBinManager",
        "tap",
        function (e) {
          self.HideDescription("PromptBinManager");
        }
      );
      Shared.AddRemoveHandler("#descriptionPromptForQty", "tap", function (e) {
        self.HideDescription("PromptForQty");
      });
      Shared.AddRemoveHandler("#descriptionQtyOnHand", "tap", function (e) {
        self.HideDescription("QtyOnHand");
      });
      Shared.AddRemoveHandler("#descriptionQuickPack", "tap", function (e) {
        self.HideDescription("QuickPack");
      });
      Shared.AddRemoveHandler(
        "#descriptionSourceTransaction",
        "tap",
        function (e) {
          self.HideDescription("SourceTransaction");
        }
      );
      Shared.AddRemoveHandler("#descriptionUseCbeImage", "tap", function (e) {
        self.HideDescription("UseCbeImage");
      });
      Shared.AddRemoveHandler("#descriptionWebSite", "tap", function (e) {
        self.HideDescription("WebSite");
      });
      Shared.AddRemoveHandler("#descriptionAutoPost", "tap", function (e) {
        self.HideDescription("AutoPost");
      });
    },

    WireCartItemEvents: function (listItemView) {
      self = this;
      Shared.AddRemoveHandler("." + listItemView.cid, "tap", function () {
        self.checkListItem_tap(listItemView);
      });
    },
  });
